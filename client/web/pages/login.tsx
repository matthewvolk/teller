            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-start">
                    <div className="flex items-center h-5">
                      <input
                        ...
                        type="checkbox"
                        className="bg-inherit w-4 h-4 border border-stone-300 rounded focus:ring-3 focus:ring-primary-300 dark:border-zinc-50 dark:focus:ring-primary-600 dark:ring-offset-stone-800"
                        required={true}
                      />
                    </div>
                  ...
                  <a className="cursor-not-allowed text-sm font-medium hover:underline dark:text-white">
                    Forgot password?
                  </a>
                </div>
                <button
